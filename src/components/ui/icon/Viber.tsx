...
export default function Viber({ ...props }: SvgIconProps) {
  return (
    <SvgIcon {...props} viewBox="0 0 631.99 666.43">
      <defs>
        <style>
          {`
              .cls-1 { fill: inherit; }
              .cls-2 { fill: none; stroke: #000; stroke-linecap: round; stroke-linejoin: round; stroke-width: 16.86px; }
            `}
        </style>
      </defs>
      <title>viber</title>
